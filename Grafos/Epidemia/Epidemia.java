...
public class Epidemia {
    ...
    public Epidemia() {
        ...
        Dan = new Persona("Dan");
        Jon.contactos.add(Ana);
        Jon.contactos.add(Peru);
        Ana.contactos.add(Peio);
        Ana.contactos.add(Isa);
        Ana.contactos.add(Jon);
        Isa.contactos.add(Ana);
        Isa.contactos.add(Iker);
        Isa.contactos.add(Dan);
        Peio.contactos.add(Ana);
        Peio.contactos.add(Iker);
        Iker.contactos.add(Peio);
        Iker.contactos.add(Isa);
        Iker.contactos.add(Fer);
        Iker.contactos.add(Peru);
        Peru.contactos.add(Jon);
        Peru.contactos.add(Fer);
        Peru.contactos.add(Tim);
        Peru.contactos.add(Iker);
        Tim.contactos.add(Peru);
        Fer.contactos.add(Iker);
        Fer.contactos.add(Peru);
        Fer.contactos.add(Elsa);
        Elsa.contactos.add(Fer);
        Elsa.contactos.add(Dan);
        Dan.contactos.add(Elsa);
        Dan.contactos.add(Isa);
